...
class WebAPP(object):
    ...
    def __init__(
            ...
            asset: Asset = None, account: Account = None,address: str = '', **kwargs
    ):
...
class AppletApplication(BaseApplication):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.driver = None
        self.app = WebAPP(
            app_name=self.app_name, user=self.user, account=self.account, asset=self.asset,address=self.asset.address
        )
    ...
    def run(self):
        ...
        self.driver.get(self.app.address)
